        ...
        PlaylistManager = function () {
            ...
            function playlistConfig(index) {
				...
				if( typeof(now_play_voice)=='function' ){
					now_play_voice(current);	//当前播放第几节的扩展函数
				}
            ...
            function playlistNext() {
				...
				if( typeof(next_voice)=='function' && (myPlaylist[index].next_topic==true||index==0) ){
					next_voice();	//下一页的扩展函数
				}else{
            ...
            function playlistPrev() {
				...
				if( typeof(prev_voice)=='function' && index==(myPlaylist.length-1) ){
					prev_voice();	//上一页的扩展函数
				}else{
...
//undo
		...
		function paythis(index){
			playlist.playlistAdvance(index);
		}
