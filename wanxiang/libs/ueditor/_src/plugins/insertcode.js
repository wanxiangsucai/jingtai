...
UE.plugins["insertcode"] = function() {
  ...
  // 自定义 insertcode 按钮
    UE.registerUI('insertcode', function(editor, uiName) {

    var btn = new UE.ui.Button({
        name: uiName,
        title: '插入代码',
        cssRules: 'editorCode1:before:content: "\e658";background-image: url(../images/icons.png);background-position: -260px -20px;',
        onclick: function() {
            // 在当前光标位置插入预设好的代码
            editor.execCommand('insertHtml', '<pre><code>// 在这里输入你的代码</code></pre>');
        }
    });

    editor.addListener('ready', function() {
        editor.ui.getToolbar('code').addItem('insertcode', btn);
    });
