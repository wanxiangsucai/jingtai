...
$(function(){
    ...
    $(".music-list").on("mousemove",".list-item", function() {
        ...
        if(!$(this).data("loadmenu")) {
            ...
            target.html() + 
            '</span>' +
			' <a href="jascript:;" class="share-to-chat" style="border:1px solid #eeeeee;font-size: 12px;">分享</a></span>' +
        ...
        layer.prompt(
        {
            ...
            btn3: function(index, layero){
                layer.open({
                    ...
                    ,content: 
                    '1、首先<a href="http://music.163.com/" target="_blank" style="color:#fa8587">点我(http://music.163.com/)</a>打开网易云音乐官网<br>' +
                    '2、然后点击页面右上角的“登录”，登录您的账号<br>' + 
                    '3、点击您的头像，进入个人中心<br>' + 
                    '4、此时浏览器地址栏 <span style="color:#fa8587">/user/home?id=</span> 后面的<span style="color:#fa8587">数字</span>就是您的网易云 UID'
                });  
            }
        },
...
function musicInfo(list, index) {
    ...
    var tempStr = '<div style="padding: 20px; line-height: 22px; background-color: #393D49; color: #fff; font-weight: 300;"><span class="info-title">歌名：</span>' + music.name + 
...
function searchBox() {
    ...
    '        <button class="search-submit" type="submit"><span class="iconfont icon-search2"></span></button>' + 
    '    </div>' + 
    '    <div class="radio-group" id="music-source">' + 
    '       <label class="leo-label"><input class="leo-radio" type="radio" name="source" value="netease" checked=""><span class="leo-radioInput"></span><img class="leo-img"  src="static/images/s-netease.png"> </label>' + 
    '       <label class="leo-label"><input class="leo-radio" type="radio" name="source" value="tencent"><span class="leo-radioInput"></span><img class="leo-img"  src="static/images/s-qq.png"></label>' + 
    '   </div>' + 
    '</div></form>';
