...
function() {
    window.Swiper = function(e, t) {
        ...
        function o(e) {
            ...
            if (! (e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === a || 39 === a || 38 === a || 40 === a) {
                    var t = !1;
                    if (h.container.parents(".hbtp").length > 0 && 0 === h.container.parents(".dangqian").length) return;
                    for (var s = {
        ...
        var p = {
            ...
            slideClass: "hbtp",
            slideActiveClass: "dangqian",
            slideVisibleClass: "hbtp-visible",
            slideDuplicateClass: "hbtp-duplicate",
            slideNextClass: "xia",
            slidePrevClass: "shang",
            wrapperClass: "haibao",
        ...
        if (f = "undefined" == typeof a ? window.Dom7 || window.Zepto || window.jQuery: a, f && (h.container = f(e), 0 !== h.container.length)) {
            ...
            h.container.addClass("tuiguang-" + h.params.direction),
            h.params.freeMode && h.container.addClass("tuiguang-free-mode"),
            (h.params.parallax || h.params.watchSlidesVisibility) && (h.params.watchSlidesProgress = !0),
            ["cube", "coverflow"].indexOf(h.params.effect) >= 0 && (h.support.transforms3d ? (h.params.watchSlidesProgress = !0, h.container.addClass("tuiguang-3d")) : h.params.effect = "slide"),
            "slide" !== h.params.effect && h.container.addClass("tuiguang-" + h.params.effect),
            ...
            h.rtl && h.container.addClass("tuiguang-rtl"),
            ...
            h.params.slidesPerColumn > 1 && h.container.addClass("tuiguang-multirow"),
            ...
            h.onResize = function() {
                if (h.updateContainerSize(), h.updateSlidesSize(), h.updateProgress(), h.params.scrollbar && h.scrollbar && h.scrollbar.set(), h.params.freeMode) {
            ...
            h.updateClickedSlide = function(e) {
                ...
                if (h.clickedSlide = a, h.clickedIndex = f(a).index(), h.params.slideToClickedSlide && void 0 !== h.clickedIndex && h.clickedIndex !== h.activeIndex) {
                    ...
                    if (h.params.loop) if (t = f(h.clickedSlide).attr("data-hbtp-index"), r > h.slides.length - h.params.slidesPerView) h.fixLoop(),
                    r = h.wrapper.children("." + h.params.slideClass + '[data-hbtp-index="' + t + '"]').eq(0).index(),
                    setTimeout(function() {
                        h.slideTo(r)
                    },
                    0);
                        ...
                        h.fixLoop();
                        var s = h.wrapper.children("." + h.params.slideClass + '[data-hbtp-index="' + t + '"]');
            ...
            h.effects = {
                ...
                cube: {
                    setTranslate: function() {
                        ...
                        for (var t = 0; t < h.slides.length; t++) {
                            ...
                            if (1 >= o && o > -1 && (a = 90 * t + 90 * o, h.rtl && (a = 90 * -t - 90 * o)), s.transform(u), h.params.cube.slideShadows) {
                                var c = s.find(r() ? ".hbtp-shadow-left": ".hbtp-shadow-top"),
                                m = s.find(r() ? ".hbtp-shadow-right": ".hbtp-shadow-bottom");
                                0 === c.length && (c = f('<div class="hbtp-shadow-' + (r() ? "left": "top") + '"></div>'), s.append(c)),
                                0 === m.length && (m = f('<div class="hbtp-shadow-' + (r() ? "right": "bottom") + '"></div>'), s.append(m)); {
                                    s[0].progress
                                }
                    ...
                    setTransition: function(e) {
                        h.slides.transition(e).find(".hbtp-shadow-top, .hbtp-shadow-right, .hbtp-shadow-bottom, .hbtp-shadow-left").transition(e),
                    ...
                    setTranslate: function() {
                        ...
                        a = r() ? -e + h.width / 2 : -e + h.height / 2, t = r() ? h.params.coverflow.rotate: -h.params.coverflow.rotate, s = h.params.coverflow.depth, i = 0, n = h.slides.length; n > i; i++) {
                            ...
                            if (o.transform(w), o[0].style.zIndex = -Math.abs(Math.round(p)) + 1, h.params.coverflow.slideShadows) {
                                var T = o.find(r() ? ".hbtp-shadow-left": ".hbtp-shadow-top"),
                                b = o.find(r() ? ".hbtp-shadow-right": ".hbtp-shadow-bottom");
                                0 === T.length && (T = f('<div class="hbtp-shadow-' + (r() ? "left": "top") + '"></div>'), o.append(T)),
                                0 === b.length && (b = f('<div class="hbtp-shadow-' + (r() ? "right": "bottom") + '"></div>'), o.append(b)),
