...
;(function( jQuery, window, document, undefined )
{
	...
	{
		var params		= jQuery.extend( { classPrefix: 'audioplayer', strPlay: 'Play', strPause: 'Pause', strVolume: 'Volume' }, params ),
			cssClass	= {},
			cssClassSub =
			{
				playPause:	 	'playpause',
		...
		this.each( function()
		{
			...
			var jQuerythis	   = jQuery( this ),
				...
				isAutoPlay = jQuerythis.get( 0 ).getAttribute( 'autoplay' ), isAutoPlay = isAutoPlay === '' || isAutoPlay === 'autoplay' ? true : false,
				isLoop	   = jQuerythis.get( 0 ).getAttribute( 'loop' ),		isLoop	   = isLoop		=== '' || isLoop	 === 'loop'		? true : false,
				isSupport  = false;
			...
			if( isSupport )
			{
				...
				{
					updateLoadBar();
					timeDuration.html( jQuery.isNumeric( theAudio.duration ) ? secondsToTime( theAudio.duration ) : '&hellip;' );
