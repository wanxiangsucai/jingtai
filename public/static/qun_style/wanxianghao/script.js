...
(function (window, jQuery) {
    jQuery(document).ready(function ($) {
        ...
        var p1 = new Image();
        p1.src = "/public/static/qun_style/wanxianghao/img/phone1.png";
        var p2 = new Image();
        p2.src = "/public/static/qun_style/wanxianghao/img/phone2.png";
        ...
        $('#fullpage').fullpage({
            ...
            scrollOverflow: true,
            anchors: ['firstPage', 'secondPage', 'thirdPage', 'fourthPage', 'fifthPage', 'footePage'],
            ...
            afterRender: function () {
                ...
                $(".third .smile /public/static/qun_style/wanxianghao/img").mouseenter(function () {
                    smileChange.stop();
        ...
        var smileChange = {
            start: function () {
                ...
                this.intervalId = setInterval(function () {
                    ...
                    $(".third .smile img").attr("src", "/public/static/qun_style/wanxianghao/img/smile-on-2.png");
                    that.timeoutId = setTimeout(function () {
                        $(".third .smile img").attr("src", "/public/static/qun_style/wanxianghao/img/smile-off-2.png");
                    }, 500);
