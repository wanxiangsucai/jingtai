        ...
        tabAdd: function(options) {
            ...
            if (icon) {
                if (icon.indexOf('fa-') !== -1) {
                    titleHtm.push('<i onclick="$(\'.kit-item[data-target=refresh]\').trigger(\'click\');$(\'.kit-tab-tool\').trigger(\'click\')" class="fa ' + icon + '" aria-hidden="true"></i>');
                } else {
